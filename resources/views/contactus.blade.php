        ...
        <section class="contactus">
            ...
            <div class="contactus__form">
                <div class="contactus__form_info">
                    ...
                    <p>
                        We encourage you to use the contact form below to send
                        us your queries, suggestions, or collaborations. Our
                        team is ready to unscramble any uncertainties and make
                        the process of connecting with us as smooth as the
                        typesetting process.
                    </p>
                    <div class="contactus__form_info__mail">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="ionicon"
                            viewBox="0 0 512 512"
                        ...
                        <div>
                            <h1>mail</h1>
                            <p>info@oprifs.org.et</p>
                        </div>
                    </div>

                    <div class="contactus__form_info__call">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="ionicon"
                            viewBox="0 0 512 512"
        ...
        <footer class="footer">
            <div class="footer__socialmedia">
                ...
                <p>
                    ...
                    Hic at illo odio debitis similique ex ad, alias illum itaque
                    minus explicabo assumenda aliquid quas reprehenderit,
                    ducimus ab? Delectus, quasi itaque.
                </p>
                <ul>
                    <li>
                        <a href="#">
