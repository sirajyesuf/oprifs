<div class="newpagecontainer">
    ...
    <section class="newslistsectionbox">
        ...
        @endforeach
            ...
            {{-- <p class="newslistsection_filter_news" wire:click="updateCategory({{  }})">news</p>
            <p class="newslistsection_filter_stories" wire:click="updateCategory({{ $post->id }})">stories</p> --}}
        </div>
